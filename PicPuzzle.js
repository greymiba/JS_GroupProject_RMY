...
function buildArray() {
	...
	for (let k = 0; k < difficulty; k++) {
		...
		for (let m = 0; m < difficulty; m++) {
			...
			console.log(tilePosArray0[k * difficulty + m]);
		}
	}
}
...
function initialize() {
	...
	let rhinoImg = new Image(600,454);
	rhinoImg.src = 'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.nationaltrust.org.uk%2Fimages%2F1431747858549-stourhead-autumn-nov-2013-2.jpg&f=1&nofb=1';
